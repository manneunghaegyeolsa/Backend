streamlit을 통해 식물 상세 정보를 확인하는 chatbot 구현   데이터셋: 건조에 강한 실내식물 https://www.nongsaro.go.kr/portal/ps/psn/psnj/openApiLst.ps?menuId=PS65428&pageIndex=1&pageSize=&sLclasCode=&sText=식물
